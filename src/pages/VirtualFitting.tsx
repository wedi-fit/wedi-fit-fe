                        ...
                        <div className="bg-white p-6 rounded-2xl border border-emerald-100 shadow-lg relative overflow-hidden">
                            ...
                            {analysisResult.visualizationImageUrl && (
                                <div className="mb-6 rounded-xl overflow-hidden border-2 border-emerald-200">
                                    <img
                                        src={`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:3001'}${analysisResult.visualizationImageUrl}`}
                                        alt="체형 분석 시각화"
                        ...
                        {compositeResults.map((result, index) => (
                            <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-lg border border-stone-200">
                                <div className="aspect-[3/4] bg-stone-100 relative">
                                    {result.success ? (
                                        <img
                                            src={`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:3001'}${result.image_url}`}
